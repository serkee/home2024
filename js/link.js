...
$(function(){
	...
	<!--//롤링링크-->
	$('.footer .footer_member .login').click(function(){
		popOpen()
		loadPage()
		function loadPage(){		
		$pageData = "member/login.html";
			$("#layPop").load($pageData);
		}
	})
	$('.footer .footer_member .join').click(function(){
		popOpen()
		loadPage()
		function loadPage(){		
		$pageData = "member/join_01.html";
			$("#layPop").load($pageData);
		}
	})
...
function loadPage(){
	...
	//SUPPORT
	else if(selectArg == 6) $pageData = "member/login.html";
	//SUPPORT
	else if(selectArg == 7) $pageData = "member/join_01.html";
